...
- [Agent Island](https://github.com/tristan666666/agent-island) - A native macOS notch and Windows tray app that reads local agent logs and credentials to show quota, cost, and live session state for five coding agents (Claude Code, Codex, Antigravity, Grok, Cursor), and alerts when a run is waiting on your input. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/tristan666666/agent-island?style=flat-square&label=)
