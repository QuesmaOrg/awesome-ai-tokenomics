...
- [aGiTrack](https://github.com/core-aix/agitrack) - A terminal wrapper for Claude Code, Codex, and OpenCode that turns each agent turn into a git commit carrying that turn's model and its input, output, cache-read, and cache-write token counts, so spend is attributable to the diff it produced. ![tool: Apache-2.0](https://img.shields.io/badge/tool-Apache--2.0-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/core-aix/agitrack?style=flat-square&label=)
