...
- [Tokenade](https://tokenade.net) - A closed-source CLI proxy that compacts command output, MCP tool results, and file reads before they reach a coding agent. Its +38.9% end-to-end cost figure on sessions above 200k tokens comes from THOL, a public benchmark with published run-level data that is maintained by Tokenade's own author and declares the conflict. ![tool: none declared](https://img.shields.io/badge/tool-none_declared-blue?style=flat-square)
...
- [ChatGPT subscription tiers and Codex CLI bundling/pricing (2026)](https://learn.chatgpt.com/docs/pricing) - OpenAI bundles Codex into every ChatGPT tier from Free through Pro (from $100/mo), differing by rate-limit multiplier; the credit rate card now prices GPT-5.6 Sol, Terra, and Luna. (checked 2026-08-22)
...
- [Google AI Pro price and Gemini/Antigravity free-tier limits (2026)](https://gemini.google/us/subscriptions/) - Google AI Pro is confirmed at $19.99/month, beneath the $99.99 and $199.99 AI Ultra tiers giving higher rate limits on the Gemini API and Antigravity. (checked 2026-08-22)
...
- [LLM token pricing dimensions - the structure of a token bill](https://platform.claude.com/docs/en/about-claude/pricing) - This maps out how frontier LLM APIs meter and price tokens, read straight off the two largest providers' pricing pages, Anthropic and OpenAI. (checked 2026-08-22)
