...
- [Wattage](https://github.com/faizannraza/wattage) - An open-source CLI that prices Claude Code sessions and OTel GenAI traces against a dated, source-cited pricing snapshot, flags waste patterns with a concrete fix each, and can fail CI on a cost regression. ![tool: Apache-2.0](https://img.shields.io/badge/tool-Apache--2.0-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/faizannraza/wattage?style=flat-square&label=)
