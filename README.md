...
- [rightmodeler](https://github.com/elm-os/rightmodeler) - An MIT-licensed TypeScript CLI that replays accepted agent traces through lower-cost candidate models and reports cost, output agreement, sample size, and abstentions before a model-selection decision; it does not route live traffic. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/elm-os/rightmodeler?style=flat-square&label=)
