...
### Tools
- [antiburn](https://github.com/antiburn/antiburn) - An open-source desktop app for macOS, Windows and Linux that reads local session logs from 11 coding agents, flags token-burn causes such as session overdepth, overpowered subagents, and unused MCP servers and skills, and applies and verifies supported configuration fixes. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/antiburn/antiburn?style=flat-square&label=)
