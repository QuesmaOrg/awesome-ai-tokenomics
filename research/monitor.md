...
- [NextReset](https://nextreset.ai/) - A free hosted Codex companion that publishes source-linked public reset history and official AI-service incident updates, with a browser-local allowance timer that does not read account usage. ![co](https://img.shields.io/badge/co-555?style=flat-square)
